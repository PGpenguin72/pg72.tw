...
### 驗題組
這個組別也是最核心的組別之一，驗題要確保題目品質，確認實體環境可不可用等，避免出題組用了一個理論可解，實際非也的題目。
...
## 第四個問題，題目在哪怎麼驗？？？
很有趣的一件事情喔，我們的題目多數集中於賽前一週內才陸續上到平台上，跟我本身預期的前一個月做好所有題目差超級超級超級超級超級多，所以這次有些題目沒有跑完流程，題目出完就沒有驗題了，然後就出了超多的事。

正常流程應該要是：出題者出題 -> 出題者本地驗題 -> 丟上 #題目 論壇+靶機+CTFd 平台 -> 驗題者本地+遠端驗題 -> 沒問題就維持原樣，否則就繼續修，回到最前面 -> 競賽前確認題目是否有誤。

但這裡我沒有想怪任何人，我認為會有這個問題也是因為我也沒有很認真地催進度，才搞出了這種題目品質不好的部分。

## 第五個問題，開賽前的事怎麼這麼多？？？
開賽前 24 小時，我花了很多的心思，確認題目有沒有問題，更新題單，安排各個時段負責的人手...etc 

安排人手的用途是因為避免競賽期間只有我負責回應，且如果我沒空時還有人可以協助回應。

我還要確認平台是不是還活著、有沒有問題，確定使用者帳密、寄送各種信件（跟我前面說的一樣）、確認學生賽區選手是否有誤...etc

看得出來事情真的很多吧www


# 競賽期間
## 第六個問題，競賽期間怎麼這麼多 Ticket？？？
...
這些都是題目品質不良的表現，沒有經過充足的驗證確認是否可解，完全背離 THJCC 一開始的初衷，而且我們這次的 Ticket 數量甚至達到了驚人的 81 張（以往只有約 20張左右），這都是很明顯的問題。
...
# 賽後
## 第七個問題，賽後成績計算怎麼改來改去啊？
比賽期間，我們遇到了一件事情，我出了一題 `Minecraft???` 題目，這個題目在我理想中，應該是最受歡迎的題目之一，因為玩家社群大，且解法過程很有趣。
...
最後我在統計排行榜時發現混入了兩個不符資格的參賽者？所以又有了這個公告：

![更新排行榜](./asset/Leak5.png)

這次排行榜更動會讓很多人不開心，而且像我說的還有不符資格的人被算進去，我都覺得我要被算計了QwQ

下次我出題不該這樣隨便亂出，而且我的題目我記得也只有簡單邏輯驗而已，沒有去裝防護 mod 避免一些預期外的狀況發生，而且規則也沒有設定好，也沒有使用動態 Flag 和 instance。

## 賽後行政
賽後其實沒有比較輕鬆，我們需要整理名次，整理本次花費還有得獎名單給 HIT（贊助商），準備給參賽者的獎品...etc

這些都並不是一件很簡單的事情，舉個例子：

這次有參賽者填單完後說還沒收到獎金，我就得去找 HIT 和他們溝通，一起找出哪裡發生了問題，確認匯款進度和重新匯報狀況。

頒獎大會的時候，我一直嘗試帶動氣氛，但參與人數其實不如預期，而且很快就結束了。

還要開檢討會議，把這次競賽遇到的問題全部整理出來，並記住下來，有興趣的可以看一下我們的檢討文件。

最後還要選出下一屆的人選，讓我們 THJCC 可以傳承。

傳承不只是傳檔案，還要告訴他們一些簡單的歷史，我們的精神，我們犯過的錯等，要讓下一屆可以正確的把比賽繼續辦下去，這才是我們想要的傳承。
...
在達克效應下，辦比賽其實真的沒有我想的這麼簡單，在我沒有詳細的相關知識的情況下，進入了 THJCC 有點壓力，我需要學習的東西很多，並不是當初所想的這麼職位一接，眼睛一閉就可以辦比賽當總召。

當總召真的不是只有指揮，你還要把 THJCC 當成自己的大型專案，用心投入在裡面，而不是把他當做是一個一次性垃圾袋，有經歷後就丟掉。

但我還是認為資安小白可以當總召，但你需要有一個願意學習一起成長的心。雖然我的資安能力不強，但我認為辦比賽可以學習到很多不同的東西，除了從中學習到資安的知識、學習如何組織一個團隊進行協作、和團隊從錯誤中學習，這些都是寶貴的經驗。

就算沒有升學誘因，我也還是會嘗試，畢竟「有說有機會」嘛，不做怎麼知道自己行不行。

如果你對當第五屆總召有興趣（因為我也是第四屆總召，別想篡我位w），或是想當工作人員一起看看 THJCC 幕後的各種，歡迎加入我們！
::link{url="https://hackmd.io/PuUAuMm7RESh8k1z9QBBbw" text="THJCC 招募文件"}
